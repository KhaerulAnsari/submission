...
import 'package:submission/home/detail_belajar_bersama.dart';
import 'package:submission/model/infoBelajar_place.dart';
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Expanded(
                                  flex: 1, child: Image.asset(place.image,fit: BoxFit.cover,)),
                              Expanded(
                                flex: 2,
                                child: Padding(
...
var infoPlaceList = [
  InfoPlace(
      ...
      text: "Jika anda tertarik untuk mempelajarinya silahkan klik tombil dibawah untuk lebih lanjut anda juga akan mendapatkan akses grub chat",
      price: "Rp 200.000",
      location: "Bandung",
      imageAssets: [
